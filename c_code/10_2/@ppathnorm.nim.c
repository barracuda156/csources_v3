...
{nimErr_ = nimErrorFlag();
	...
	nimlf_(120, "/opt/local/lib/nim/lib/pure/pathnorm.nim");	if ((path_p0.len) < ((NI)0) || (path_p0.len) > ((NI)IL64(9223372036854775807))){ raiseRangeErrorI(path_p0.len, ((NI)0), ((NI)IL64(9223372036854775807))); goto BeforeRet_;
	}
