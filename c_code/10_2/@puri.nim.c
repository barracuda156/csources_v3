...
{nimErr_ = nimErrorFlag();
	...
	nimlf_(82, "/Users/svacchanda/Dev/nim-2.2.6/lib/pure/uri.nim");	if (nimAddInt(s_p0.len, (NI)((NI64)(s_p0.len) >> (NU64)(((NI)2))), &TM__VzbRQH9cb1xm1tSKH4PwBSw_2)) { raiseOverflow(); goto BeforeRet_;
	};
