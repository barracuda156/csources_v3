...
} TM__r4WvUOkTx4ylahJtpRE9aTQ_11 = { 7 | NIM_STRLIT_FLAG, "//user/" };
...
LA12_: ;
	...
	T14_ = base_2;
	addNormalizePath__pureZpathnorm_u87(T14_, (&result), (&state_1), 92);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	nimln_(85);	T15_.len = 0; T15_.p = NIM_NIL;
	T15_ = f_p1;
	addNormalizePath__pureZpathnorm_u87(T15_, (&result), (&state_1), 92);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		LA1_:;
	}
...
LA12_: ;
	...
	T16_ = f_p1;
	addNormalizePath__pureZpathnorm_u87(T16_, (&result), (&state_1), 92);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		LA1_:;
	}
...
{nimErr_ = nimErrorFlag();
	nimlf_(108, "/Users/svacchanda/Dev/nim-2.2.6/compiler/pathutils.nim");	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!T3_) goto LA4_;
		nimln_(109);		result = ((NI)3);
	}
	goto LA1_;
LA4_: ;
	{
		nimln_(111);		result = ((NI)0);
	}
LA1_: ;
	}BeforeRet_: ;
	popFrame();
...
static N_INLINE(void, nimAddCharV1)(NimStringV2* s_p0, NIM_CHAR c_p1) {
	NI TM__r4WvUOkTx4ylahJtpRE9aTQ_14;
{	prepareAdd(s_p0, ((NI)1));
	(*(*s_p0).p).data[(*s_p0).len] = c_p1;
	if (nimAddInt((*s_p0).len, ((NI)1), &TM__r4WvUOkTx4ylahJtpRE9aTQ_14)) { raiseOverflow(); goto BeforeRet_;
	};
	(*s_p0).len = (NI)(TM__r4WvUOkTx4ylahJtpRE9aTQ_14);
...
{	result.len = 0; result.p = NIM_NIL;
	...
	if (((NI)(TM__r4WvUOkTx4ylahJtpRE9aTQ_13)) < ((NI)0) || ((NI)(TM__r4WvUOkTx4ylahJtpRE9aTQ_13)) > ((NI)2147483647)){ raiseRangeErrorI((NI)(TM__r4WvUOkTx4ylahJtpRE9aTQ_13), ((NI)0), ((NI)2147483647)); goto BeforeRet_;
	}
	result = rawNewString(((NI)(TM__r4WvUOkTx4ylahJtpRE9aTQ_13)));
...
LA6_: ;
				{
					NI TM__r4WvUOkTx4ylahJtpRE9aTQ_15;
					nimln_(126);					if (i_1 < 0 || i_1 >= s_p0.len){ raiseIndexError2(i_1,s_p0.len-1); goto BeforeRet_;
					}
					if (!((NU8)(s_p0.p->data[i_1]) == (NU8)(47))) goto LA9_;
					nimln_(127);					if (nimSubInt(slashes_1, ((NI)1), &TM__r4WvUOkTx4ylahJtpRE9aTQ_15)) { raiseOverflow(); goto BeforeRet_;
					};
					slashes_1 = (NI)(TM__r4WvUOkTx4ylahJtpRE9aTQ_15);
				}
				goto LA4_;
LA9_: ;
LA4_: ;
				nimlf_(131, "/Users/svacchanda/Dev/nim-2.2.6/lib/system/iterators_1.nim");				if (nimAddInt(i_2, ((NI)1), &TM__r4WvUOkTx4ylahJtpRE9aTQ_16)) { raiseOverflow(); goto BeforeRet_;
				};
				i_2 = (NI)(TM__r4WvUOkTx4ylahJtpRE9aTQ_16);
			} LA3: ;
		}
	}
	}BeforeRet_: ;
...
{nimErr_ = nimErrorFlag();
	...
	nimlf_(143, "/Users/svacchanda/Dev/nim-2.2.6/compiler/pathutils.nim");	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		result = customPathImpl__pathutils_u254(colontmpD__3);
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		{
			LA6_:;
		}
...
LA4_: ;
	{
		...
		nimln_(147);		{
			...
			colontmpD__4 = relevantPart__pathutils_u237(x_p0, slashes_1);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			T14_ = rawNewString(colontmpD__4.len + 7);
appendString((&T14_), TM__r4WvUOkTx4ylahJtpRE9aTQ_12);
