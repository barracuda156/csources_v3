...
{nimErr_ = nimErrorFlag();
	...
	nimlf_(26, "/Users/svacchanda/Dev/nim-2.2.6/lib/std/private/osappdirs.nim");	nimln_(7);	nimln_(26);	T2_.len = 0; T2_.p = NIM_NIL;
...
{nimErr_ = nimErrorFlag();
	...
	nimlf_(74, "/Users/svacchanda/Dev/nim-2.2.6/lib/std/private/osappdirs.nim");	colontmpD_ = getEnv__stdZenvvars_u16(TM__XnRPlAiwKKY6TokjvYVCvw_11, TM__XnRPlAiwKKY6TokjvYVCvw_12);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
