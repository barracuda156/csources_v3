...
LA12_: ;
	...
	{
		nimlf_(1699, "/opt/local/lib/nim/lib/system.nim");		eqdestroy___system_u2629(base_2);
	}
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
	popFrame();
...
{nimErr_ = nimErrorFlag();
	...
	nimlf_(49, "/Users/svacchanda/Dev/nim-2.2.6/compiler/pathutils.nim");	{
		...
		if (!T4_) goto LA5_;
		colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
		nimlf_(1699, "/opt/local/lib/nim/lib/system.nim");		colontmpD_ = eqdup___system_u2635(path_p0);
		result = colontmpD_;
	}
	goto LA2_;
LA5_: ;
...
LA9_: ;
LA4_: ;
				nimlf_(131, "/opt/local/lib/nim/lib/system/iterators_1.nim");				if (nimAddInt(i_2, ((NI)1), &TM__r4WvUOkTx4ylahJtpRE9aTQ_21)) { raiseOverflow(); goto BeforeRet_;
				};
...
{nimErr_ = nimErrorFlag();
	...
	nimlf_(95, "/Users/svacchanda/Dev/nim-2.2.6/compiler/pathutils.nim");	{
		...
		if (!T3_) goto LA4_;
		colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
		nimlf_(1699, "/opt/local/lib/nim/lib/system.nim");		colontmpD_ = eqdup___system_u2635(file_p0);
		result = colontmpD_;
	}
	goto LA1_;
LA4_: ;
