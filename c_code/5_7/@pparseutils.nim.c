...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, substr__system_u8373)(NIM_CHAR* a_p0, NI a_p0Len_0);
...
{	T1_ = NIM_NIL;
	...
	nimlf_(429, "/Users/svacchanda/Dev/nim-2.2.6/lib/pure/parseutils.nim");	raiseExceptionEx((Exception*)T1_, "ValueError", "integerOutOfRangeError", "/Users/svacchanda/Dev/nim-2.2.6/lib/pure/parseutils.nim", 429);
goto BeforeRet_;
	}BeforeRet_: ;
	popFrame();
}
...
LA7_: ;
		{
			...
			nimln_(442);			if (nimAddInt(i_1, ((NI)1), &TM__vI9aZNKIcImom6dDyKXW1ZA_14)) { raiseOverflow(); goto BeforeRet_;
			};
...
LA21_: ;
				...
				nimln_(448);				{
					...
					nimln_(449);					if (nimMulInt64((*b_p1), IL64(10), &TM__vI9aZNKIcImom6dDyKXW1ZA_17)) { raiseOverflow(); goto BeforeRet_;
					};
...
LA22_: ;
				nimln_(452);				if (nimAddInt(i_1, ((NI)1), &TM__vI9aZNKIcImom6dDyKXW1ZA_21)) { raiseOverflow(); goto BeforeRet_;
				};
...
LA35_: ;
		{
			...
			nimln_(457);			if (nimMulInt64((*b_p1), sign_1, &TM__vI9aZNKIcImom6dDyKXW1ZA_23)) { raiseOverflow(); goto BeforeRet_;
			};
...
{	result = (NI)0;
	nimlf_(510, "/Users/svacchanda/Dev/nim-2.2.6/lib/pure/parseutils.nim");	i_1 = ((NI)0);
	nimln_(511);	{
		NIM_BOOL T3_;
...
LA4_: ;
		if (!T3_) goto LA5_;
		if (nimAddInt(i_1, ((NI)1), &TM__vI9aZNKIcImom6dDyKXW1ZA_24)) { raiseOverflow(); goto BeforeRet_;
		};
...
LA16_: ;
				...
				if (nimSubInt(((NU8)(s_p0[i_1])), ((NI)48), &TM__vI9aZNKIcImom6dDyKXW1ZA_25)) { raiseOverflow(); goto BeforeRet_;
				};
				...
				nimln_(516);				{
					...
					if (nimSubInt(((NI)2147483647), c_1, &TM__vI9aZNKIcImom6dDyKXW1ZA_26)) { raiseOverflow(); goto BeforeRet_;
					};
					if (!((*b_p1) <= (NI)(((NI)(TM__vI9aZNKIcImom6dDyKXW1ZA_26)) / (((NI)10))))) goto LA19_;
					nimln_(517);					if (nimMulInt((*b_p1), ((NI)10), &TM__vI9aZNKIcImom6dDyKXW1ZA_27)) { raiseOverflow(); goto BeforeRet_;
					};
					if (nimAddInt((NI)(TM__vI9aZNKIcImom6dDyKXW1ZA_27), c_1, &TM__vI9aZNKIcImom6dDyKXW1ZA_28)) { raiseOverflow(); goto BeforeRet_;
					};
...
LA17_: ;
				nimln_(520);				if (nimAddInt(i_1, ((NI)1), &TM__vI9aZNKIcImom6dDyKXW1ZA_29)) { raiseOverflow(); goto BeforeRet_;
				};
...
LA25_: ;
						if (!T24_) goto LA23;
						if (nimAddInt(i_1, ((NI)1), &TM__vI9aZNKIcImom6dDyKXW1ZA_30)) { raiseOverflow(); goto BeforeRet_;
						};
...
LA5_: ;
		T3_ = T4_;
		if (!(T3_)) goto LA6_;
		if (nimAddInt(i_1, ((NI)1), &TM__vI9aZNKIcImom6dDyKXW1ZA_32)) { raiseOverflow(); goto BeforeRet_;
		};
...
LA12_: ;
		if (!T11_) goto LA13_;
		if (nimAddInt(i_1, ((NI)1), &TM__vI9aZNKIcImom6dDyKXW1ZA_33)) { raiseOverflow(); goto BeforeRet_;
		};
...
LA24_: ;
				if (!T23_) goto LA22;
				nimln_(536);				{
					if (!((NU64)(1844674407370955161ULL) < (NU64)(res_1))) goto LA27_;
...
LA27_: ;
				...
				nimln_(540);				if (i_1 < 0 || i_1 >= s_p0Len_0){ raiseIndexError2(i_1,s_p0Len_0-1); goto BeforeRet_;
				}
				if (nimSubInt(((NU8)(s_p0[i_1])), ((NI)48), &TM__vI9aZNKIcImom6dDyKXW1ZA_34)) { raiseOverflow(); goto BeforeRet_;
				};
				res_1 += ((NU64) ((NI)(TM__vI9aZNKIcImom6dDyKXW1ZA_34)));
				nimln_(541);				{
					if (!((NU64)(res_1) < (NU64)(prev_1))) goto LA31_;
					nimln_(542);					integerOutOfRangeError__pureZparseutils_u325();
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				}
LA31_: ;
				nimln_(543);				if (nimAddInt(i_1, ((NI)1), &TM__vI9aZNKIcImom6dDyKXW1ZA_35)) { raiseOverflow(); goto BeforeRet_;
				};
...
LA36_: ;
						if (!T35_) goto LA34;
						if (nimAddInt(i_1, ((NI)1), &TM__vI9aZNKIcImom6dDyKXW1ZA_36)) { raiseOverflow(); goto BeforeRet_;
						};
...
LA4_: ;
		if (!T3_) goto LA5_;
		nimln_(227);		if (nimAddInt(i_1, ((NI)1), &TM__vI9aZNKIcImom6dDyKXW1ZA_38)) { raiseOverflow(); goto BeforeRet_;
		};
...
LA10_: ;
				if (!T9_) goto LA8;
				if (nimAddInt(i_1, ((NI)1), &TM__vI9aZNKIcImom6dDyKXW1ZA_39)) { raiseOverflow(); goto BeforeRet_;
				};
		...
		T11_ = substr__system_u8373((NIM_CHAR*)(s_p0)+(((NI)0)), ((NI)(TM__vI9aZNKIcImom6dDyKXW1ZA_40))-(((NI)0))+1);
