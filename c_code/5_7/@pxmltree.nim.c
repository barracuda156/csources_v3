...
static const struct {
  NI cap; NIM_CHAR data[4+1];
} TM__qYyKc6OpDWHHaBXL9bX9aQ2A_5 = { 4 | NIM_STRLIT_FLAG, "&gt;" };
static const NimStringV2 TM__qYyKc6OpDWHHaBXL9bX9aQ2A_6 = {4, (NimStrPayload*)&TM__qYyKc6OpDWHHaBXL9bX9aQ2A_5};
static const struct {
  NI cap; NIM_CHAR data[5+1];
} TM__qYyKc6OpDWHHaBXL9bX9aQ2A_7 = { 5 | NIM_STRLIT_FLAG, "&amp;" };
static const NimStringV2 TM__qYyKc6OpDWHHaBXL9bX9aQ2A_8 = {5, (NimStrPayload*)&TM__qYyKc6OpDWHHaBXL9bX9aQ2A_7};
static const struct {
  NI cap; NIM_CHAR data[6+1];
} TM__qYyKc6OpDWHHaBXL9bX9aQ2A_9 = { 6 | NIM_STRLIT_FLAG, "&quot;" };
static const NimStringV2 TM__qYyKc6OpDWHHaBXL9bX9aQ2A_10 = {6, (NimStrPayload*)&TM__qYyKc6OpDWHHaBXL9bX9aQ2A_9};
static const struct {
  NI cap; NIM_CHAR data[6+1];
...
{	{
		...
		if (nimAddInt((*dest_p0).len, src_p1.len, &TM__qYyKc6OpDWHHaBXL9bX9aQ2A_4)) { raiseOverflow(); goto BeforeRet_;
		};
		(*dest_p0).len = (NI)(TM__qYyKc6OpDWHHaBXL9bX9aQ2A_4);
...
{	prepareAdd(s_p0, ((NI)1));
	...
	if (nimAddInt((*s_p0).len, ((NI)1), &TM__qYyKc6OpDWHHaBXL9bX9aQ2A_13)) { raiseOverflow(); goto BeforeRet_;
	};
	(*s_p0).len = (NI)(TM__qYyKc6OpDWHHaBXL9bX9aQ2A_13);
...
appendString((&(*result_p0)), TM__qYyKc6OpDWHHaBXL9bX9aQ2A_6);
				}
				break;
				case 38:
				{
					nimln_(706);					prepareAdd((&(*result_p0)), 5);
appendString((&(*result_p0)), TM__qYyKc6OpDWHHaBXL9bX9aQ2A_8);
				}
				break;
				case 34:
				{
					nimln_(707);					prepareAdd((&(*result_p0)), 6);
appendString((&(*result_p0)), TM__qYyKc6OpDWHHaBXL9bX9aQ2A_10);
				}
				break;
				case 39:
				{
					nimln_(708);					prepareAdd((&(*result_p0)), 6);
appendString((&(*result_p0)), TM__qYyKc6OpDWHHaBXL9bX9aQ2A_12);
				}
				break;
				default:
				{
...
{nimErr_ = nimErrorFlag();
	...
	nimlf_(727, "/Users/svacchanda/Dev/nim-2.2.6/lib/pure/xmltree.nim");	if ((s_p0.len) < ((NI)0) || (s_p0.len) > ((NI)2147483647)){ raiseRangeErrorI(s_p0.len, ((NI)0), ((NI)2147483647)); goto BeforeRet_;
	}
