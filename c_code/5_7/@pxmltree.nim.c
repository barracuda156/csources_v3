...
{nimErr_ = nimErrorFlag();
	...
	nimlf_(727, "/opt/local/lib/nim/lib/pure/xmltree.nim");	if ((s_p0.len) < ((NI)0) || (s_p0.len) > ((NI)2147483647)){ raiseRangeErrorI(s_p0.len, ((NI)0), ((NI)2147483647)); goto BeforeRet_;
	}
