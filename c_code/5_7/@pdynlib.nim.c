...
{nimErr_ = nimErrorFlag();
	nimlf_(78, "/Users/svacchanda/Dev/nim-2.2.6/lib/pure/dynlib.nim");	le_1 = nsuFindChar(s_p0, 40, ((NI)0), ((NI)-1));
...
LA4_: ;
		...
		prefix_1 = substr__system_u8401(s_p0, ((NI)0), (NI)(TM__Vbi6rBBOqdMySprhH3iUcg_3));
		nimln_(82);		if (nimAddInt(ri_1, ((NI)1), &TM__Vbi6rBBOqdMySprhH3iUcg_4)) { raiseOverflow(); goto LA7_;
		};
		suffix_1 = substr__system_u8414(s_p0, (NI)(TM__Vbi6rBBOqdMySprhH3iUcg_4));
		{
			...
			colontmp_ = substr__system_u8401(s_p0, (NI)(TM__Vbi6rBBOqdMySprhH3iUcg_5), (NI)(TM__Vbi6rBBOqdMySprhH3iUcg_6));
...
LA19_: ;
					...
					T21_ = substr__system_u8401(colontmp_, firstX60gensym34__1, (NI)(TM__Vbi6rBBOqdMySprhH3iUcg_8));
