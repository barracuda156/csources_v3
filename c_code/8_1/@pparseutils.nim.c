...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, substr__system_u8351)(NIM_CHAR* a_p0, NI a_p0Len_0);
...
LA10_: ;
		...
		T11_ = substr__system_u8351((NIM_CHAR*)(s_p0)+(((NI)0)), ((NI)(TM__vI9aZNKIcImom6dDyKXW1ZA_40))-(((NI)0))+1);
