...
colontmpD_.p = NIM_NIL;
	nimlf_(25, "/Users/svacchanda/Dev/Nim/lib/std/private/osappdirs.nim");	nimln_(7);	nimln_(25);T2_.len = 0;
T2_.p = NIM_NIL;
...
result.len = 0;
result.p = NIM_NIL;
	nimlf_(72, "/Users/svacchanda/Dev/Nim/lib/std/private/osappdirs.nim");result = getEnv__stdZenvvars_u36(TM__XnRPlAiwKKY6TokjvYVCvw_9, TM__XnRPlAiwKKY6TokjvYVCvw_10);
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
