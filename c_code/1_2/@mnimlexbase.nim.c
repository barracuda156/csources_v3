...
LA11_: ;
	...
	charsRead_1 = llStreamRead__llstream_u437(T14_, ((void*) ((&(*L_p0).buf[toCopy_1]))), (NI)(TM__jNFaG9cOzyJSKBcIonhGRGw_12));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
LA37_: ;
					...
					T39_ = (*L_p0).stream;
					charsRead_1 = llStreamRead__llstream_u437(T39_, ((void*) ((&(*L_p0).buf[oldBufLen_1]))), oldBufLen_1);
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					nimln_(115);					{
...
{nimErr_ = nimErrorFlag();
	nimln_(74);	llStreamClose__llstream_u182((*L_p0).stream);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}BeforeRet_: ;
	popFrame();
}
