...
NIM_BOOL* nimErr_;
	nimfr_("prepareConfigNotes", "/Users/svacchanda/Dev/nim-2.2.6/compiler/pipelineutils.nim");
{nimErr_ = nimErrorFlag();
	nimlf_(18, "/Users/svacchanda/Dev/nim-2.2.6/compiler/pipelineutils.nim");	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
...
LA4_: ;
	{
		nimln_(21);		{
			tySet_tyEnum_TMsgKind__9aQXjCbHLIif7xJLUycnHUw T9_;
			nimZeroMem(T9_, sizeof(tySet_tyEnum_TMsgKind__9aQXjCbHLIif7xJLUycnHUw));
...
NIM_BOOL* nimErr_;
	nimfr_("resolveMod", "/Users/svacchanda/Dev/nim-2.2.6/compiler/pipelineutils.nim");
{nimErr_ = nimErrorFlag();
	result = (NI32)0;
