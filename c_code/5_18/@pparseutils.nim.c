...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, substr__system_u8394)(NIM_CHAR* a_p0, NI a_p0Len_0);
...
LA16_: ;
				...
				nimln_(516);				{
					...
					if (nimSubInt(((NI)IL64(9223372036854775807)), c_1, &TM__vI9aZNKIcImom6dDyKXW1ZA_26)) { raiseOverflow(); goto BeforeRet_;
					};
...
LA10_: ;
		...
		T11_ = substr__system_u8394((NIM_CHAR*)(s_p0)+(((NI)0)), ((NI)(TM__vI9aZNKIcImom6dDyKXW1ZA_40))-(((NI)0))+1);
