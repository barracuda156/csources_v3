...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, substr__system_u8391)(NIM_CHAR* a_p0, NI a_p0Len_0);
...
{	T1_ = NIM_NIL;
	...
	nimlf_(429, "/opt/local/lib/nim/lib/pure/parseutils.nim");	raiseExceptionEx((Exception*)T1_, "ValueError", "integerOutOfRangeError", "/opt/local/lib/nim/lib/pure/parseutils.nim", 429);
goto BeforeRet_;
	}BeforeRet_: ;
	popFrame();
}
...
{	result = (NI)0;
	nimlf_(510, "/opt/local/lib/nim/lib/pure/parseutils.nim");	i_1 = ((NI)0);
	nimln_(511);	{
		NIM_BOOL T3_;
...
LA10_: ;
		...
		T11_ = substr__system_u8391((NIM_CHAR*)(s_p0)+(((NI)0)), ((NI)(TM__vI9aZNKIcImom6dDyKXW1ZA_40))-(((NI)0))+1);
