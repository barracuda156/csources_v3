...
LA17_: ;
	{
		...
		int status_1;
		int status2_1;
		nimlf_(227, "/opt/local/lib/nim/lib/std/private/osfiles.nim");		state_1 = copyfile_state_alloc();
...
LA25_: ;
		nimlf_(236, "/opt/local/lib/nim/lib/std/private/osfiles.nim");		status2_1 = copyfile_state_free(state_1);
		nimln_(237);		{
