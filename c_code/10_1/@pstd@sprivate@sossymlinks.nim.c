...
{nimErr_ = nimErrorFlag();
	...
	nimlf_(68, "/Users/svacchanda/Dev/nim-2.2.6/lib/std/private/ossymlinks.nim");	bufLen_1 = ((NI)1024);
	{
		nimln_(69);		while (1) {
			NimStringV2 T3_;
			NI len_1;
			nimlf_(1699, "/Users/svacchanda/Dev/nim-2.2.6/lib/system.nim");			nimlf_(70, "/Users/svacchanda/Dev/nim-2.2.6/lib/std/private/ossymlinks.nim");			if ((bufLen_1) < ((NI)0) || (bufLen_1) > ((NI)2147483647)){ raiseRangeErrorI(bufLen_1, ((NI)0), ((NI)2147483647)); goto BeforeRet_;
			}
...
LA6_: ;
			nimln_(74);			{
				...
				nimln_(75);				if ((len_1) < ((NI)0) || (len_1) > ((NI)2147483647)){ raiseRangeErrorI(len_1, ((NI)0), ((NI)2147483647)); goto BeforeRet_;
				}
