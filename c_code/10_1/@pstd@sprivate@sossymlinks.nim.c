...
{nimErr_ = nimErrorFlag();
	...
	nimlf_(68, "/opt/local/lib/nim/lib/std/private/ossymlinks.nim");	bufLen_1 = ((NI)1024);
	{
		nimln_(69);		while (1) {
			NimStringV2 T3_;
			NI len_1;
			nimlf_(1699, "/opt/local/lib/nim/lib/system.nim");			nimlf_(70, "/opt/local/lib/nim/lib/std/private/ossymlinks.nim");			if ((bufLen_1) < ((NI)0) || (bufLen_1) > ((NI)2147483647)){ raiseRangeErrorI(bufLen_1, ((NI)0), ((NI)2147483647)); goto BeforeRet_;
			}
