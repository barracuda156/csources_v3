...
LA32_: ;
				{
					...
					nimln_(110);					if (((*L_p0).bufLen) < ((NI)0) || ((*L_p0).bufLen) > ((NI)2147483647)){ raiseRangeErrorI((*L_p0).bufLen, ((NI)0), ((NI)2147483647)); goto BeforeRet_;
					}
...
LA3_: ;
	...
	nimlf_(1699, "/opt/local/lib/nim/lib/system.nim");	nimlf_(153, "/Users/svacchanda/Dev/nimv2/compiler/nimlexbase.nim");	if ((bufLen_p2) < ((NI)0) || (bufLen_p2) > ((NI)2147483647)){ raiseRangeErrorI(bufLen_p2, ((NI)0), ((NI)2147483647)); goto BeforeRet_;
	}
...
{	result = (NI)0;
	...
	if ((NI)(TM__jNFaG9cOzyJSKBcIonhGRGw_28) == (-2147483647 -1)){ raiseOverflow(); goto BeforeRet_;
	}
