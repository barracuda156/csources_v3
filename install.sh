...
if [ $# -eq 1 ] ; then
  ...
  case $1 in
    ...
    "/usr/bin")
      ...
      nimbleDir="/opt/nimble/pkgs/nim-"
      ;;
    "/usr/local/bin")
      bindir=$1
      configdir="/etc/nim"
      libdir="/usr/local/lib/nim/lib"
  ...
  cp "lib/system/ptrarith.nim" "$libdir/system/ptrarith.nim"
  chmod 644 "$libdir/system/ptrarith.nim"
  ...
  cp "compiler/layeredtable.nim" "$nimbleDir/compiler/layeredtable.nim"
  chmod 644 "$nimbleDir/compiler/layeredtable.nim"
